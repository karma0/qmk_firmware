...
[_WORKMAN] = LAYOUT_planck_grid(
    ...
    LSFT_T(KC_LSFT), CTL_T(KC_Z),    KC_X,    KC_M,          KC_C,    KC_V, KC_K,   KC_L,   KC_COMM, KC_DOT,  CTL_T(KC_SLSH), KC_RSFT,
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Brite| Ctrl | Alt  |CtlAlt| Bksp | Dead | Enter| Space| Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
